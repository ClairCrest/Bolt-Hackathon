  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <a
        ...
        className="absolute top-4 right-4 sm:top-6 sm:right-6 z-10 transition-transform duration-200 hover:scale-110"
        title="Built with bolt.new"
      >
        <img
          src={BoltBadge}
          alt="Built with bolt.new"
          className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 drop-shadow-lg hover:drop-shadow-xl transition-all duration-200"
        />
      </a>
