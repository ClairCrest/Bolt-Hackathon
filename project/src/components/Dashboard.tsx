...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 relative">
      {/* Discord Badge - Positioned in top-left corner */}
      <a
        href="https://discord.gg/DSD8mEr6kg"
        target="_blank"
        rel="noopener noreferrer"
        className="group fixed top-4 left-4 sm:top-6 sm:left-6 z-20 transition-all duration-300 ease-in-out hover:scale-105"
        title="Join our Discord community"
      >
        <div className="flex items-center bg-white/90 backdrop-blur-sm rounded-full shadow-lg border border-gray-200/50 overflow-hidden transition-all duration-300 ease-in-out group-hover:shadow-xl group-hover:shadow-purple-500/20">
          {/* Discord Logo */}
          ...
          {/* Expandable Text */}
          <div className="overflow-hidden transition-all duration-300 ease-in-out w-0 group-hover:w-20 sm:group-hover:w-24 md:group-hover:w-28">
        ...
        {/* Discord brand color glow effect on hover */}
        <div className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-400/30 to-purple-500/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur-lg"></div>
      </a>
