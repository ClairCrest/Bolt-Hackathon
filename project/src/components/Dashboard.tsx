...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 relative">
      {/* Responsive Discord Badge */}
      <a
        href="https://discord.gg/DSD8mEr6kg"
        target="_blank"
        rel="noopener noreferrer"
        className="group fixed top-4 left-4 sm:top-6 sm:left-6 z-50 transition-all duration-300 ease-in-out hover:scale-105"
      ...
      >
        <div className="flex items-center bg-white/90 backdrop-blur-sm rounded-full shadow-lg border border-gray-200/50 overflow-hidden transition-all duration-300 ease-in-out group-hover:shadow-xl group-hover:shadow-indigo-500/25">
          ...
          <div className="flex-shrink-0">
            <img
              src={DiscordCanary}
              alt="Discord"
              className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 transition-all duration-300 p-1"
            />
          </div>
          ...
          <div className="overflow-hidden transition-all duration-300 ease-in-out w-0 group-hover:w-20 sm:group-hover:w-24 md:group-hover:w-28">
            <div className="px-3 py-2 whitespace-nowrap">
              <span className="text-indigo-700 font-semibold text-xs sm:text-sm md:text-base opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                Join Us
              </span>
            </div>
          </div>
        ...
        <div className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-400/20 to-purple-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur-lg"></div>
      </a>
