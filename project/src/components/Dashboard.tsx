  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const mockResult = {
        ...
        pdf_link: 'https://arxiv.org/pdf/example.pdf',
        bibtex: '@article{example}',
        summary: `This is a mock summary for your search query: "${searchQuery}". In a real implementation, this would be generated by AI after analyzing relevant research papers from ArXiv.`
      };
      
      setSearchResult(mockResult);
      
      // Save to Supabase (optional, might fail if not configured)
      try {
        await supabase.table('papers').insert({
          title: mockResult.title,
          authors: mockResult.authors,
          published: mockResult.published,
          pdf_link: mockResult.pdf_link,
          bibtex: mockResult.bibtex,
      ...
      setSearchError('Search functionality is in demo mode. Backend connection required for full functionality.');
    } finally {
  ...
  const handleFileUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const mockResult = {
        ...
        summary: `This is a mock analysis of your uploaded file: ${uploadedFile.name}. In a real implementation, this would be generated by AI after processing the PDF content.`
      };
      ...
      setUploadError('Upload functionality is in demo mode. Backend connection required for full functionality.');
    } finally {
